...
public class MoD_sort extends JFrame {
  ...
  // start attributes
    ...
    private JNumberField nfAnzahlPositionswechsel = new JNumberField();
    public int[] unsorted = new int[50];

    private JLabel lAnzahlVergleiche = new JLabel();
    private JLabel lAnzahlPositionswechsel = new JLabel();
    ...
    public MoD_sort() {
        ...
        setLocation(x, y);
        setTitle("Sortieren eines Arrays mit Bubblesort");
        setResizable(false);
    ...
    // start components
        ...
        cp.add(bSort);
        nfLaenge.setBounds(144, 10, 41, 25);
        nfLaenge.setText("50");
        cp.add(nfLaenge);
        ...
        nfAnzahlPositionswechsel.setBounds(800, 72, 117, 33);
        nfAnzahlPositionswechsel.setText("");
        cp.add(nfAnzahlPositionswechsel);
        ...
        nfAnzahlVergleiche.setBounds(425, 72, 65, 33);
        nfAnzahlVergleiche.setText("");
        nfAnzahlVergleiche.setEditable(false);
        cp.add(nfAnzahlVergleiche);
        // Ende Komponenten
